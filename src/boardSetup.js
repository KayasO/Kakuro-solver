...
export function EASY_4x4() {
  return [
    [null, new Entry(0, 7), new Entry(0, 24), null, null],
    [new Entry(9, 0), new WhiteCell(), new WhiteCell(), new Entry(0, 17), null],
    [
      new Entry(16, 0),
      new WhiteCell(),
      new WhiteCell(),
    ...
    [null, new Entry(24, 0), new WhiteCell(), new WhiteCell(), new WhiteCell()],
    [null, null, new Entry(16, 0), new WhiteCell(), new WhiteCell()],
  ]
}
